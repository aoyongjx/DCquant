...
df = pd.read_csv(filepath_or_buffer='E:\\02-py\\51bitqunt\\binance_api\\cvs\\1586495340000.csv'
                 # ,
                 # skiprows=1
                 # ,
                 # usecols=['open_time','open,high','low','close','volume','close_time','quote_volume',
                 #          'trades','taker_base_volue','taker_quote_volume','ignore']
                 # ,
                 #nrows=10
                 )
# print(df)
